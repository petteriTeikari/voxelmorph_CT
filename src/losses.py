...
class Miccai2018():
    ...
    def __init__(self, image_sigma, prior_lambda, flow_vol_shape=None):
        ...
        print('Miccai2018 loss with')
        print(' image_sigma = {}'.format(self.image_sigma))
        print(' prior_lambda = {}'.format(self.prior_lambda))
        print(' D = {}'.format(self.D))
        print(' flow_vol_shape = {}'.format(self.flow_vol_shape))
    ...
    def _degree_matrix(self, vol_shape):
        ...
        print('_degree_matrix')
        print(' vol_shape = {}'.format(vol_shape))
