...
if __name__ == "__main__":
    ...
    parser.add_argument("data_dir", type=str,
                        default = '/home/petteri/Dropbox/manuscriptDrafts/CThemorr/DATA_DVC/sCROMIS2ICH/CT/labeled/MNI_1mm_256vx-3D/data/BM4D_brainWeighed_nonNaN_-100_npz_2mm_debug',
                        help="data folder")

    parser.add_argument("--atlas_file", type=str,
                        dest="atlas_file", default='../data/JohnHopkins_CQ500_template_2.0mm_norm.npz',
                        help="gpu id number")
    parser.add_argument("--model_dir", type=str,
                        dest="model_dir", default='../models/',
                        help="models folder")
    # atm every epoch is saved, and if you sync this in Dropbox, overwhelm London bandwidth
    parser.add_argument("--model_dir_intermediate", type=str,
                        dest="model_dir_intermediate", default='../models_intermediate_when_training/',
                        help="models folder")
    ...
    parser.add_argument("--steps_per_epoch", type=int,
                        dest="steps_per_epoch", default=209,
                        help="frequency of model saves")
    parser.add_argument("--batch_size", type=int,
                        dest="batch_size", default=1,
                        help="batch_size")
    parser.add_argument("--load_model_file", type=str,
                        dest="load_model_file", default='../models/sCROMIS2ICH_2mm_128vx.h5',
